package lng.demo.rabbitmq.client;
...
public class RabbitConfig implements RabbitListenerConfigurer {
    ...
    Queue autoOrderQueue() {
        ...
        return QueueBuilder.durable(orderQ).withArgument("x-dead-letter-exchange", RETRY_EXCHANGE)
    ...
    Queue autoRetryQueue() {
        ...
        return QueueBuilder.durable(retryQ).withArgument("x-message-ttl", 4000).withArgument("x-dead-letter-exchange", MAIN_EXCHANGE)
    ...
    Exchange autoErrorExchange() {
        return ExchangeBuilder.topicExchange(ERROR_EXCHANGE).build();
    }
